...
INTERNAL_ERROR = f'Ой, что-то пошло не так. {TRY_AGAIN_LATER}'
...
REMARK_ABOUT_NOTIFICATION = 'Рекомендуем выключить уведомления, т.к. в ближайшее время будет множество смс!'
